...
import com.iu33.crudfirebase.activity.DatabaseFirebaseActivity;
import com.iu33.crudfirebase.activity.LoginActivity;
import com.iu33.crudfirebase.admob.AdmobActivity;
...
public class MainActivity extends MyFunction {
    ...
    @OnClick({R.id.changeEmail, R.id.changePass, R.id.send, R.id.remove, R.id.change_email_button, R.id.change_password_button, R.id.sending_pass_reset_button, R.id.remove_user_button, R.id.sign_out})
                    ...
                    auth.sendPasswordResetEmail(om).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (!task.isSuccessful()) {
                                ...
                                Toast.makeText(MainActivity.this, "berhasil ganti email", Toast.LENGTH_SHORT).show();
                                auth.signOut();
                                //                           startActivity(new Intent(MainActivity.this,LoginActivity.class));
                                finish();
                            }
